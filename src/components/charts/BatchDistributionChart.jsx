...
export const BatchDistributionChart = ({ data, currentGPA, avgGPA }) => (
  <ResponsiveContainer width="100%" height={220}>
    <BarChart data={data} margin={{ top: 5, right: 20, left: -20, bottom: 5 }}>
      ...
      {currentGPA !== null && <ReferenceLine x={Number(currentGPA.toFixed(2))} stroke="#f87171" strokeWidth={2} strokeDasharray="5 3" label={{ value: 'You', fill: '#f87171', fontSize: 11, position: 'top' }} />}
      {avgGPA !== null && <ReferenceLine x={Number(avgGPA.toFixed(2))} stroke="#fbbf24" strokeWidth={2} strokeDasharray="5 3" label={{ value: 'Avg', fill: '#fbbf24', fontSize: 11, position: 'top' }} />}
